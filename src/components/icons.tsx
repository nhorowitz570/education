...
const paths: Record<string, string> = {
  ...
  venture: 'M3.5 10 5 5h14l1.5 5M4 10h16M5 10v10h14V10M10 20v-5h4v5M4 10a2 2 0 0 0 4 0 2 2 0 0 0 4 0 2 2 0 0 0 4 0 2 2 0 0 0 4 0',
  star: 'M12 3.5l2.6 5.3 5.9.9-4.3 4.1 1 5.8L12 16.9l-5.2 2.7 1-5.8-4.3-4.1 5.9-.9z',
  notebook: 'M6 3.5h11a2 2 0 0 1 2 2v15H8a2 2 0 0 1-2-2zM6 18.5a2 2 0 0 1 2-2h11M10 8h5M10 11.5h3',
  text: 'M3.5 18 8.5 6h1l5 12M5.5 14h7M16.5 11.5a2.5 2.5 0 0 1 4.5 1.5v5M21 15.5c-.8-.6-1.7-.8-2.6-.8-1.4 0-2.4.8-2.4 1.9s.9 1.9 2.2 1.9c1.2 0 2.2-.6 2.8-1.5',
  sound: 'M4 9.5h3.5L12 5.5v13l-4.5-4H4zM15.5 9a4.2 4.2 0 0 1 0 6M18 6.5a7.8 7.8 0 0 1 0 11',
  share: 'M12 15V3.5M8 7.5l4-4 4 4M5 12.5V19a1.5 1.5 0 0 0 1.5 1.5h11A1.5 1.5 0 0 0 19 19v-6.5',
  ...
  session: 'M4 6.5h16M4 12h10M4 17.5h7M17 15l4 2.5-4 2.5z',
  rhythm: 'M4 5.5h16v14H4zM4 10h16M8.5 3.5v3M15.5 3.5v3M8 14h2M11 14h2M14 14h2M8 16.5h2',
};
